...
export default class SickLeave extends React.Component
{
    constructor()
    {
        super()
    ...
    async HandleSubmit3(event)
   {
    ...
    await axios.post('http://localhost:4000/am/sickleave', {requestid:this.state.reqid,targetdate:this.state.targetdate,document:this.state.document,reason:this.reason},{ headers: {
